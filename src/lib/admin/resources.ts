...
export const RESOURCES: ResourceConfig[] = [
  ...
  },
  {
    ...
    group: 'Content',
    titleColumn: 'title',
    listColumns: ['title', 'slug', 'status', 'updated_at'],
    searchColumns: ['title', 'slug'],
    orderBy: { column: 'updated_at', ascending: false },
    publishable: true,
    softDelete: true,
    ...
    fields: [
      { name: 'title', label: 'Title', type: 'text', required: true, max: 200 },
      {
        ...
        type: 'slug',
        required: true,
        help: 'The post lives at /blog/<slug>. Use the words people search for.',
      },
      {
        name: 'category_id',
        label: 'Category',
      ...
      },
      {
        ...
        type: 'reference',
        reference: 'programs',
        help: 'Leave empty when the post applies to both programmes.',
      },
      {
        name: 'summary',
        label: 'Summary',
        ...
        rows: 2,
        max: 500,
        help: 'One or two sentences. Shown under the title, in lists and in search results.',
      },
      { name: 'body_mdx', label: 'Body', type: 'mdx', section: 'content', rows: 28 },
      { name: 'sources', label: 'Official sources', type: 'sources', section: 'content' },
      {
        ...
        label: 'Tags',
        type: 'tags',
        help: 'Comma separated. Posts that share tags are shown as related.',
      },
      {
        name: 'is_featured',
        label: 'Featured on the blog home',
        type: 'boolean',
        section: 'publishing',
      },
      { name: 'sort_order', label: 'Sort order in its category', type: 'number', default: 0 },
      {
        name: 'last_reviewed_at',
        label: 'Last reviewed (IST)',
        type: 'datetime',
  ...
  },
  {
    ...
    fields: [
      { name: 'name', label: 'Name', type: 'text', required: true, max: 80 },
      {
        ...
        type: 'slug',
        required: true,
        help: 'The category lives at /blog/category/<slug>.',
      },
      { name: 'description', label: 'Description', type: 'textarea', rows: 2, max: 500 },
      { name: 'intro_mdx', label: 'Introduction', type: 'mdx', section: 'content', rows: 10 },
      { name: 'sort_order', label: 'Sort order', type: 'number', default: 0 },
      ...publishing,
      ...seo,
    ],
