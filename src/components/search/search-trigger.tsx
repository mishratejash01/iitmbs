  ...
  return (
    <>
      <a
        ...
        className="flex min-h-11 items-center gap-2 rounded-control text-muted transition-colors hover:text-text md:w-56 md:border md:border-border md:bg-surface md:px-3 md:hover:border-border-strong max-md:size-11 max-md:justify-center"
        aria-label="Search"
        aria-keyshortcuts="Control+K Meta+K"
      >
        <Search aria-hidden="true" className="size-5 md:size-4" />
        <span className="hidden flex-1 text-small md:inline">Search…</span>
        <kbd className="hidden rounded border border-border bg-card px-1.5 text-xs text-muted md:inline">⌘K</kbd>
      </a>
