...
export default async function SettingsPage() {
  ...
  return (
    <div className="container-reading space-y-10">
      ...
      <section aria-labelledby="profile-heading" className="rounded-card border border-border bg-card p-4 sm:p-6">
      ...
      <section aria-labelledby="analytics-heading" className="rounded-card border border-border bg-card p-4 sm:p-6">
      ...
      <section aria-labelledby="data-heading" className="rounded-card border border-border bg-card p-4 sm:p-6">
        <h2 id="data-heading" className="text-h3 font-semibold">
          Your data
        </h2>
        <p className="mt-2 text-small text-muted">
          Download a copy of everything linked to your account: profile, bookmarks, history, progress, feedback and analytics.
        </p>
        <a
          href="/api/me/export"
      ...
      <section aria-labelledby="danger-heading" className="rounded-card border border-danger/30 bg-danger-soft p-4 sm:p-6">
