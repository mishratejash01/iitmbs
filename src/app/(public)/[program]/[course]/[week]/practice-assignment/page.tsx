...
export async function generateMetadata({ params }: PageProps<'/[program]/[course]/[week]/practice-assignment'>): Promise<Metadata> {
  return assignmentMetadata(await params, 'practice')
}

export default async function Page({ params }: PageProps<'/[program]/[course]/[week]/practice-assignment'>) {
